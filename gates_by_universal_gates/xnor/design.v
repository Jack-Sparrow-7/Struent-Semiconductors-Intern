...
// XNOR gate implemented using NOR gates
module xnor_by_nor (
    a,
    b,
    out
    ...
    nor_gate nor4(.a(nor2_out), .b(nor3_out), .out(out));

endmodule


// XNOR gate implemented using NAND gates
module xnor_by_nand (
    a,
    b,
    out
    ...
    nand_gate nand4(.a(nand2_out), .b(nand3_out), .out(nand4_out));
    nand_gate nand5(.a(nand4_out), .b(nand4_out), .out(out));
